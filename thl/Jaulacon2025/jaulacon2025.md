...
### Post-Explotación
Desde Meterpreter se verifico el sistema de archivos. Se reviso el archivo `users.php` y se 
encontraron hashes:
![11](11.png)
...
Se identifico que `busctl` podía ser ejecutado como root sin contrasena:  
![14](14.png)
````
sudo -l
````
